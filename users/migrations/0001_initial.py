# Generated by Django 3.0.8 on 2021-02-12 08:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.AccountUser')),
            ],
        ),
        migrations.CreateModel(
            name='Role',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='manager', to='users.AccountUser', verbose_name='About Us')),
                ('insti', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Organization')),
            ],
        ),
        migrations.CreateModel(
            name='LoanOfficer',
            fields=[
                ...
                ('signup_date', models.DateTimeField()),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Department')),
                ('info', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='officer', to='users.AccountUser', verbose_name='About Us')),
                ('insti', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Organization')),
            ],
        ),
        migrations.CreateModel(
